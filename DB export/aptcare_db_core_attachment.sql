...
CREATE TABLE `core_attachment` (
  ...
  PRIMARY KEY (`id`),
  KEY `core_attachment_complaint_id_d83a4b4d_fk_core_complaint_id` (`complaint_id`),
  CONSTRAINT `core_attachment_complaint_id_d83a4b4d_fk_core_complaint_id` FOREIGN KEY (`complaint_id`) REFERENCES `core_complaint` (`id`)
