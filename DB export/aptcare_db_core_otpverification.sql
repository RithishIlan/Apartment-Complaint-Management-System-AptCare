...
CREATE TABLE `core_otpverification` (
  ...
  PRIMARY KEY (`id`),
  KEY `core_otpverification_user_id_a19c28f5_fk_core_customuser_id` (`user_id`),
  CONSTRAINT `core_otpverification_user_id_a19c28f5_fk_core_customuser_id` FOREIGN KEY (`user_id`) REFERENCES `core_customuser` (`id`)
...
-- Dump completed on 2026-03-26 20:48:30
